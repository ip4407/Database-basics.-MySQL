...
CREATE TABLE likes (
	...
	why_media_id BIGINT UNSIGNED NOT NULL,
	created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
	INDEX likes_who_user_id_idx (who_user_id),
  	INDEX likes_whom_user_id_idx (whom_user_id),
  	INDEX likes_why_media_id_idx (why_media_id),
  	CONSTRAINT fk_likes_who_users FOREIGN KEY (who_user_id) REFERENCES users (id),
  	CONSTRAINT fk_likes_whom_users FOREIGN KEY (whom_user_id) REFERENCES users (id),
